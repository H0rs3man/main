...
get_data = pd.read_csv('E:\\Documents\\MQE\Projects\\7Vision\\Final\\display_dataframe.csv')
...
if not protocols:
    ...
    with up_col1:
        ...
        st.subheader('Rank Select Score')
        st.bar_chart(data = data,x = "protocol", y ="Score",color = "#653e87")
